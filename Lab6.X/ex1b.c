...
void main(void){
    ...
    SPBRG=104; //set baud rate to 19200
    SPBRGH=0;
    ...
    // Set the button on RC3 to trigger an interrupt
    PIE1bits.RCIE = 1; //Enable to trigger on PIE1 (REGISTERS ASSOCIATED WITH SYNCHRONOUS MASTER TRANSMISSION)
